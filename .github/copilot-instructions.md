...
- Follow **established best practices** for the language being written.
- Keep the codebase:
...
2. **Extensive Testing**: Test all edge cases and possible use cases before considering a feature complete
...
5. **Clear Documentation**: Update COMPILER.md with implementation status when working on the compiler
6. **Consistent Style**: Follow existing code style and conventions strictly
7. **Thoughtful Debugging**: Analyze failures carefully instead of making blind fixes

>! WHEN WORKING ON THE COMPILER, UPDATE THE COMPILER.md FILE TO REFLECT THE CURRENT IMPLEMENTATION STATUS OF FEATURES.
>! WHEN WORKING ON THE COMPILER, ALWAYS REFERENCE THE IMPLEMENTATION_PLAN.md FILE FOR GUIDANCE ON FEATURE IMPLEMENTATION ORDER AND DETAILS.
